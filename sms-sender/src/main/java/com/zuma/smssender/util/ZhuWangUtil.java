...
import com.zuma.smssender.dto.zhuwang.ZhuWangHeader;
...
public class ZhuWangUtil {
    ...
    /**
     * 从输入流中读取字节注入ZhuWangHeader对象
     */
    public static void setHeader(DataInputStream inputStream, ZhuWangHeader header) throws IOException {
