 ...
 * 筑望 交付短信接口
 */
public interface ZhuWangDeliverAPI {
    ...
    class Request extends ZhuWangHeader {
        ...
        public Request(byte[] data) throws IOException {
            ...
            this.setDestId(ZhuWangUtil.getStringForInput(dins,21));

            this.setServiceId(ZhuWangUtil.getStringForInput(dins,10));
            ...
            this.setSrcTerminalId(ZhuWangUtil.getStringForInput(dins,21));
            ...
            if (this.getRegisteredDeliver() == 1) {
                ...
                msgContent.setStat(ZhuWangUtil.getStringForInput(dins,7));
                ZhuWangDeliverStatEnum statEnum = EnumUtil.getByCode(msgContent.getStat(), ZhuWangDeliverStatEnum.class);
                msgContent.setStatString(statEnum == null ? ZhuWangDeliverStatEnum.OTHEER.getMessage() : statEnum.getMessage());

                msgContent.setSubmitTime(ZhuWangUtil.getStringForInput(dins,10));
                msgContent.setDoneTime(ZhuWangUtil.getStringForInput(dins,10));

                msgContent.setDestTerminalId(ZhuWangUtil.getStringForInput(dins,21));
                ...
                //否则应该是短信上行,内容就为短信内容
                this.setOtherMsgContent(ZhuWangUtil.getStringForInput(dins,this.getMsgLength()));
            }

            this.setReserved(ZhuWangUtil.getStringForInput(dins,8));
    ...
    class Response extends ZhuWangHeader {
        ...
        private Long msgId;
        /**
         * 结果,详见{@link com.zuma.smssender.enums.error.ZhuWangSubmitErrorEnum}枚举
         */
        private byte result;
