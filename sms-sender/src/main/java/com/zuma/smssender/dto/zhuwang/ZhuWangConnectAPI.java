...
import com.zuma.smssender.enums.error.ZhuWangConnectErrorEnum;
 ...
 * 筑望 连接 接口
 */
public interface ZhuWangConnectAPI {
    //请求
    @Data
    @Builder
    @NoArgsConstructor
    ...
    class Request extends ZhuWangHeader {
        ...
        public byte[] toByteArray() throws IOException {
            ...
            ZhuWangUtil.writeString(dataOutputStream, this.sourceAddr, 6);
    ...
    class Response extends ZhuWangHeader {
        ...
        public Response(byte[] data) throws IOException {
            ...
            ZhuWangConnectErrorEnum statusEnum = EnumUtil.getByCode(this.getStatus(), ZhuWangConnectErrorEnum.class);
            this.setStatusString(statusEnum == null ? ZhuWangConnectErrorEnum.OTHER_ERROR.getMessage() : statusEnum.getMessage());
            this.authenticatorISMG = ZhuWangUtil.getBytesForInput(dins,16);
